	...
	return '
		<article id="featured-post-1" class="hentry post post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/blog-01-420x280.jpg" />
			</figure>
		...
		<article id="featured-post-2" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/blog-02-420x280.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h2 class="entry-title">
		...
		<article id="featured-post-3" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/blog-03-420x280.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h2 class="entry-title">
...
function rock_star_post_page_category_content( $options ) {
	...
	while ( $loop->have_posts()) : $loop->the_post(); $i++;
		...
		<article id="featured-post-' . $i . '" class="featured-page-post hentry">';
			...
			$image = '<img class="pngfix wp-post-image" src="'.get_template_directory_uri().'/images/gallery/no-featured-image-1920x800.jpg" >';
