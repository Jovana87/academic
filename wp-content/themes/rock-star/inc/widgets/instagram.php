			...
			<select id="<?php echo $this->get_field_id( 'size' ); ?>" name="<?php echo $this->get_field_name( 'size' ); ?>" class="widefat">
				<?php
					$post_type_choices = array(
						'thumbnail' => __( 'Thumbnail', 'rock-star' ),
						'small'     => __( 'Small', 'rock-star' ),
						'large'     => __( 'Large', 'rock-star' ),
						'original'  => __( 'Original', 'rock-star' ),
					);
...
add_action('widgets_init',
	create_function('', 'return register_widget("rock_star_instagram_widget");')
);
